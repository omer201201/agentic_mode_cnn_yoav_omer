...
class DynamicLowLightAgent:
    ...
    def _get_dynamic_params(self, l_channel):
        ...
        if avg_brightness < 20:
            clip_limit, gamma, denoise = 4.0, 0.70, 15
        elif avg_brightness < 30:
            clip_limit, gamma, denoise = 3.0, 0.80, 12
        elif avg_brightness < 40:
            clip_limit, gamma, denoise =  3.0, 0.85, 10
        elif avg_brightness < 80:
            clip_limit, gamma, denoise = 2, 1.0, 5
        elif avg_brightness < 100:
            clip_limit, gamma, denoise = 1, 1.0, 0
        else:
    ...
    def process(self, image):
        ...
        if denoise > 0:
            final_bgr = cv2.fastNlMeansDenoisingColored(final_bgr, None, denoise, denoise, 7, 11)
...
def main():
        ...
        # 2. Load a dark image
        img_path = r"C:\Users\Your0124\pycharm_project_test\baseline_with_gate\result_IMG_6962.JPG"

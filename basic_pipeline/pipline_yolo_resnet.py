...
# Ensure the script can see the other modules in the project
...
# ---------------------------------------------------------
# BASELINE PIPELINE (The Control Group)
# PURPOSE: Runs the raw YOLO -> ResNet pipeline WITHOUT the Adaptive Gate
# or any restoration agents. Used to benchmark and prove the value of the
# advanced system.
# ---------------------------------------------------------
class BaselinePipeline:
    def __init__(self):
        ...
        # 4. Normalization Tensors (Standard ImageNet Stats)
...
if __name__ == "__main__":
    ...
    test_folder_path = os.path.join(PROJECT_ROOT, "data", "resnet_dataset", "testpipline")

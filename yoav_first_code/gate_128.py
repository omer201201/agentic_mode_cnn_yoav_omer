...
class AdaptiveGate:
    ...
    def resize_with_padding(self, img, target_size=64):
        """
    ...
    def process(self, face_crop):
        ...
        processed_face = self.resize_with_padding(face_crop, target_size=64)
...
def main():
    ...
    folder_path = os.path.join( "my_custom_dataset")

...
def load_final_model(model_path, num_classes):
    #PURPOSE: Rebuilds the neural network architecture in memory and injects
    #the custom-trained weights into it.
    # 1. Load the "blank" ResNet18 architecture without pre-trained ImageNet weights
    model = models.resnet18(weights=None)

    # 2. Modify the final classification layer
    # ResNet normally outputs 1000 classes. We rip out that final layer and
    # replace it with one that outputs exactly the number of people in our dataset.
    num_ftrs = model.fc.in_features
    model.fc = nn.Linear(num_ftrs, num_classes)

    # 3. Load the specific trained weights into this architecture
...
if __name__ == "__main__":
    ...
    MODEL_FILE = r"C:\Users\yoavt\PycharmProjects\final_projact\models\resnet18_11.pt"
    MAPPING_FILE = r"C:\Users\yoavt\PycharmProjects\final_projact\models\class_mapping.json"

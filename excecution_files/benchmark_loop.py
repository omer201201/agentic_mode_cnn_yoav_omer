...
# Ensures the benchmark can run on any machine (Laptop or Jetson)
...
# ------------------------------------------
# MASTER BENCHMARK
# Automates the testing of all degradation categories.
# It runs head-to-head comparisons of the Basic Pipeline vs Gated Pipeline,
# logs time/accuracy metrics, and generates pie charts.
# ------------------------------------------
class PipelineBenchmark:
    ...
    def run_benchmark(self, test_folder, output_csv, condition_name):
        ...
        # --- Print Analytics Summary to Console & CSV ---

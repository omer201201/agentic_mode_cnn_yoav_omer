...
class PipelineBenchmark:
    ...
    def run_benchmark(self):
        #The main testing loop that executes the A/B comparison.
        headers = [
        ...
        # Grab all valid images (handling both upper and lowercase extensions)
        ...
        # Open the CSV file and start streaming data into it
        with open(OUTPUT_CSV, mode='w', newline='') as f:
            ...
            for filename in image_files:
                ...
                for res in results:
                    ...
                    # Route the image to the appropriate mathematical/AI agent
                    ...
                    # Run the *fixed* image through ResNet
